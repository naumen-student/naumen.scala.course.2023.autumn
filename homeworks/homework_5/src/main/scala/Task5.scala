...
object Task5 extends App {
  ...
  object MyEither {
    ...
    private case class MyLeft[+E, +A](error: E) extends MyEither[E, Nothing] {
      def isError: Boolean = true
    }

    private case class MyRight[+E, +A](value: A) extends MyEither[Nothing, A] {
    ...
    implicit def myEitherMonad[E]: MonadError[MyEither, E] = new MonadError[MyEither, E] {
      ...
      def handleError[A](fa: MyEither[E, A])(handle: E => A): MyEither[E, A] = fa match {
        ...
        case MyLeft(exc) => MyRight(handle(exc))
      }
    }
  }
