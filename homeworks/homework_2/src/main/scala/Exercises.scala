...
object Exercises {
    ...
    def sumScalars(leftVec0: Vector2D, leftVec1: Vector2D, function: (Vector2D, Vector2D) => Double,rightVec0: Vector2D, rightVec1: Vector2D) =
        function(leftVec0, leftVec1) + function(rightVec0, rightVec1) * function(rightVec0)

    def sumCosines(leftVec0: Vector2D, leftVec1: Vector2D, function: (Vector2D,  Vector2D)=> Double,rightVec0: Vector2D, rightVec1: Vector2D)=
        function(scalar(rightVec0,leftVec0)/( function(leftVec0, leftVec1) + function(rightVec0, rightVec1)) / (function(leftVec0, leftVec1) + function(rightVec0, rightVec1)))
    ...
    */
    ...
    def sortByHeavyweight(ballsArray: Map[String, (Int, Double)] = balls): Seq[String] = {
        def weight = (tuple: (Int, Double)) => 4 / 3 * java.lang.Math.PI * java.lang.Math.pow(tuple._1, 3) * tuple._2
